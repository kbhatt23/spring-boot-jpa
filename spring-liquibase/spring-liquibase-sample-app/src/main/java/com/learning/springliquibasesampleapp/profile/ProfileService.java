package com.learning.springliquibasesampleapp.profile;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.learning.springliquibasesampleapp.breed.BreedRepository;
...
public class ProfileService {
	...
	public void addProfile(NewProfileRequest newProfileRequest) {
		...
		if (newProfileRequest.getBreedId() != null) {
			profile.setBreed(breedRepository.findById(newProfileRequest.getBreedId()).orElse(null));
		}
